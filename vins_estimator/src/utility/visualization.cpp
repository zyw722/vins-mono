...
#include "/home/zhangyuanwei/slamworks/vins-mono-catkin_ws/src/VINS-Mono/pose_graph/src/pose_graph_node.h"
...
// double ref_long;
// double ref_lati;
// bool drone_state_receive = false;


// void drone_state_cb(const common_msgs::drone_state::ConstPtr &msg)
// {
//     drone_state_from_fcu = *msg;
//     if(drone_state_from_fcu.ref_gps_position.latitude != 0)
//     {
//         ref_lati = drone_state_from_fcu.ref_gps_position.latitude;
//         ref_long = drone_state_from_fcu.ref_gps_position.longitude;
//         drone_state_receive = true;
//         cout<<"起点纬度"<<ref_lati<<endl;
//         cout<<"起点经度"<<ref_long<<endl;
//     }
...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        // std::array<double, 2> WGS84Reference{gps_position.latitude, gps_position.longitude};
